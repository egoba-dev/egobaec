...
',
  ...
  array (
    ...
    'rental.admin.rental.title' => 'レンタル管理',
    'rental.admin.rental.sub_title' => '現在のレンタル状況',
    'rental.admin.rental.tooltip' => '現在レンタル中または予約中の商品一覧です。',
    'rental.admin.rental.list_title' => 'レンタル中商品一覧',
    'rental.admin.rental.id' => 'ID',
    'rental.admin.rental.product_name' => '商品名',
    'rental.admin.rental.order_no' => '注文番号',
    'rental.admin.rental.customer_name' => '顧客名',
    'rental.admin.rental.rental_start_date' => 'レンタル開始日',
    'rental.admin.rental.rental_end_date' => 'レンタル終了予定日',
    'rental.admin.rental.return_date' => '返却日',
    'rental.admin.rental.status' => '状態',
    'rental.admin.rental.edit_title' => 'レンタル情報編集',
    'rental.admin.rental.edit_sub_title' => 'レンタル情報の詳細編集',
    'rental.admin.rental.basic_info' => '基本情報',
    'rental.admin.rental.to_order' => '注文情報を表示',
    'rental.admin.rental.rental_info' => 'レンタル情報',
    'rental.admin.rental.not_found' => 'レンタル情報が見つかりません',
    'rental.admin.rental.save_complete' => 'レンタル情報を保存しました',
    'rental.admin.rental.return' => '返却処理',
    'rental.admin.rental.return_complete' => '返却処理が完了しました',
    'rental.admin.rental.return_error' => '返却処理中にエラーが発生しました',
    'rental.admin.rental.cancel' => 'キャンセル',
    'rental.admin.rental.cancel_confirm' => 'このレンタルをキャンセルしてもよろしいですか？',
    'rental.admin.rental.cancel_complete' => 'キャンセル処理が完了しました',
    'rental.admin.rental.cancel_error' => 'キャンセル処理中にエラーが発生しました',
    'rental.admin.rental.no_data' => 'レンタル中の商品はありません。',
    'rental.admin.history.title' => 'レンタル履歴',
    'rental.admin.history.sub_title' => '過去のレンタル履歴',
    'rental.admin.history.tooltip' => '返却済みまたはキャンセルされたレンタル履歴です。',
    'rental.admin.history.list_title' => 'レンタル履歴一覧',
    'rental.admin.history.no_data' => 'レンタル履歴はありません。',
    'rental.admin.overdue.title' => '返却遅延管理',
    'rental.admin.overdue.sub_title' => '返却期限切れの商品',
    'rental.admin.overdue.tooltip' => '返却期限を過ぎているレンタル商品です。',
    'rental.admin.overdue.list_title' => '返却遅延商品一覧',
    'rental.admin.overdue.overdue_days' => '遅延日数',
    'rental.admin.overdue.days' => '日',
    'rental.admin.overdue.no_data' => '返却遅延の商品はありません。',
    'rental.admin.overdue.updated' => '%count%件の遅延情報を更新しました。',
    'rental.admin.order.status.reserved' => 'レンタル予約中',
    'rental.admin.order.status.renting' => 'レンタル中',
    'rental.admin.order.status.returned' => '返却済み',
    'rental.admin.order.status.overdue' => '返却遅延',
    'rental.admin.order.status.canceled' => 'キャンセル',
    'rental.admin.order.rental_start_date' => 'レンタル開始日',
    'rental.admin.order.rental_end_date' => 'レンタル終了日',
    'rental.admin.order.return_date' => '返却日',
    'rental.admin.order.rental_status' => 'レンタル状態',
    'rental.admin.order.end_date_must_be_greater' => '終了日は開始日より後である必要があります。',
    'rental.admin.product.rental_flg' => 'レンタル対象',
    'rental.admin.product.rental_price_daily' => '日額レンタル料金',
    'rental.admin.product.rental_price_weekly' => '週額レンタル料金',
    'rental.admin.product.rental_price_monthly' => '月額レンタル料金',
    'rental.admin.product.rental_max_days' => '最大レンタル日数',
    'rental.admin.product.greater_than_zero' => '0より大きい値を入力してください',
    'rental.admin.config.title' => 'レンタル設定',
    'rental.admin.config.sub_title' => 'レンタル機能の全般設定',
    'rental.admin.config.basic_info' => '基本設定',
    'rental.admin.config.rental_terms' => 'レンタル利用規約',
    'rental.admin.config.auto_approval' => '自動承認',
    'rental.admin.config.default_max_days' => 'デフォルト最大レンタル日数',
    'rental.admin.config.default_max_days_note' => '特に指定がない商品に適用される最大レンタル日数です。',
    'rental.admin.config.auto_approval_note' => '自動承認を有効にすると、注文完了時に自動的にレンタル予約が承認されます。',
    'rental.admin.config.terms_info' => '利用規約設定',
    'rental.admin.config.rental_terms_note' => 'レンタル利用時にフロント画面に表示される利用規約です。',
    'rental.admin.config.save_complete' => '設定を保存しました。',
    'rental.admin.config.greater_than_zero' => '0より大きい値を入力してください。',
    'rental.admin.common.operation' => '操作',
    'rental.admin.common.back' => '戻る',
    'rental.admin.common.save' => '保存',
    'rental.admin.common.edit' => '編集',
    'rental.front.rental_title' => 'レンタル予約',
    'rental.front.rental_start_date' => 'レンタル開始日',
    'rental.front.rental_period' => 'レンタル期間',
    'rental.front.rental_end_date' => '返却予定日',
    'rental.front.rental_price' => 'レンタル料金',
    'rental.front.add_to_cart' => 'レンタルカートに追加',
    'rental.front.rental_terms_notes' => '※レンタル商品は必ず期限内にご返却ください。期限を過ぎますと延滞料金が発生します。',
    'rental.front.status.reserved' => '予約中',
    'rental.front.status.renting' => 'レンタル中',
    'rental.front.status.returned' => '返却済み',
    'rental.front.status.overdue' => '返却遅延',
    'rental.front.status.canceled' => 'キャンセル',
    'rental.front.return_date' => '返却日',
    'rental.front.product.not_found' => '商品が見つかりません。',
    'rental.front.product.not_rental' => 'この商品はレンタルできません。',
    'rental.front.product.not_available' => '商品は現在レンタルできません。',
    'rental.front.form.invalid' => '入力内容に誤りがあります。',
    'rental.front.cart.add_complete' => 'レンタル商品をカートに追加しました。',
    'rental.front.start_date_must_be_tomorrow' => 'レンタル開始日は明日以降の日付を指定してください。',
    'rental.front.mypage.title' => 'マイページ',
    'rental.front.mypage.rental_history' => 'レンタル履歴',
    'rental.front.mypage.no_history' => 'レンタル履歴はありません。',
    'rental.front.add_to_cart_success' => 'レンタル商品をカートに追加しました',
    'rental.front.add_to_cart_error' => 'レンタル商品をカートに追加できませんでした',
    'rental.front.invalid_parameter' => '入力内容に不備があります',
    'rental.admin.rental.status_updated' => 'ステータスを更新しました',
    'rental.admin.rental.overdue_updated' => '%count%件の延滞情報を更新しました',
    'rental.admin.product.tab_title' => 'レンタル設定',
    'rental.admin.product.rental_setting' => 'レンタル情報',
    'rental.admin.product.rental_flg_tooltip' => 'この商品をレンタル対象にする場合はチェックをしてください',
    'rental.admin.order.title' => 'レンタル注文管理',
    'rental.admin.order.sub_title' => 'レンタル注文一覧',
    'rental.admin.order.create_new' => '新規登録',
    'rental.admin.order.search_condition' => '検索条件',
    'rental.admin.order.reservation_id' => '予約番号',
    'rental.admin.order.rental_period' => 'レンタル期間',
    'rental.admin.order.product_name' => '商品名',
    'rental.admin.order.customer_name' => '顧客名',
    'rental.admin.order.quantity' => '数量',
    'rental.admin.order.price' => '金額',
    'rental.admin.order.status' => 'ステータス',
    'rental.admin.order.status_labels.reserved' => '予約中',
    'rental.admin.order.status_labels.renting' => 'レンタル中',
    'rental.admin.order.status_labels.returned' => '返却済み',
    'rental.admin.order.status_labels.overdue' => '返却遅延',
    'rental.admin.order.status_labels.canceled' => 'キャンセル済み',
    'rental.admin.order.change_to_renting' => 'レンタル中に変更',
    'rental.admin.order.change_to_returned' => '返却済みに変更',
    'rental.admin.order.change_to_overdue' => '返却遅延に変更',
    'rental.admin.order.change_to_canceled' => 'キャンセルに変更',
    'rental.admin.order.change_to_reserved' => '予約中に戻す',
    'rental.admin.order.delete_confirm_title' => 'レンタル注文の削除',
    'rental.admin.order.delete_confirm_message' => 'レンタル注文「%id%」を削除してもよろしいですか？',
    'rental.admin.search.reservation_id' => '予約番号',
    'rental.admin.search.product_name' => '商品名',
    'rental.admin.search.customer_name' => '顧客名',
    'rental.admin.search.status' => 'ステータス',
    'rental.admin.search.start_date_from' => 'レンタル開始日（From）',
    'rental.admin.search.start_date_to' => 'レンタル開始日（To）',
    'rental.front.options' => 'オプション',
    'rental.front.remarks' => '備考',
    'rental.front.form.next' => '次へ',
    'rental.payment.title' => 'お支払い方法の選択',
    'rental.payment.next' => '次へ進む',
    'rental.payment.error' => '決済処理中にエラーが発生しました。もう一度お試しください。',
    'rental.payment.method.label' => 'お支払い方法',
    'rental.payment.method.title' => 'お支払い方法',
    'rental.payment.method.cash' => '現金払い（店舗受取時）',
    'rental.payment.method.cod' => '代金引換',
    'rental.payment.confirm.title' => '注文内容の確認',
    'rental.payment.confirm.button' => '注文を確定する',
    'rental.payment.complete.title' => 'ご予約ありがとうございました',
    'rental.payment.complete.thank_you' => 'レンタルのご予約ありがとうございました',
    'rental.payment.complete.message' => 'レンタルのご予約が完了しました。',
    'rental.payment.complete.reservation_id' => '予約番号は「%id%」です。',
    'rental.payment.complete.mypage_message' => 'マイページから予約状況を確認することができます。',
    'rental.payment.complete.cash_instruction' => 'ご予約いただいた商品は店舗にてお支払い後にお渡しいたします。予約番号をメモしてお持ちください。',
    'rental.payment.complete.cod_instruction' => '商品のお届け時に配送業者へ代金をお支払いください。',
    'rental.payment.complete.to_mypage' => 'マイページへ',
    'rental.payment.complete.to_top' => 'トップページへ',
    'rental.payment_confirm.title' => '注文内容の確認',
    'rental.payment_confirm.button' => '注文を確定する',
    'rental.payment_confirm.message' => '以下の内容で注文を確定します。よろしければ「注文を確定する」ボタンを押してください。',
    'rental.payment_complete.title' => 'ご注文ありがとうございます',
    'rental.payment_complete.message' => 'レンタル予約が完了しました。',
    'rental.confirm.product_name' => '商品名',
    'rental.confirm.rental_period' => 'レンタル期間',
    'rental.confirm.quantity' => '数量',
    'rental.confirm.options' => '選択オプション',
    'rental.confirm.remarks' => '備考',
    'rental.confirm.total_amount' => '合計金額',
    'rental.confirm.customer_name' => '注文者名',
    'rental.confirm.delivery_address' => '送り先住所',
    'rental.option.insurance' => '保険加入（破損時の補償あり）',
    'rental.option.extension' => '延長オプション（最大1週間延長可能）',
    'rental.option.delivery' => '配送オプション（配送料込み）',
    'rental.common.required' => '必須',
    'rental.common.back' => '戻る',
    'rental.common.back_to_top' => 'トップページへ戻る',
    'maker.admin.save.complete' => 'メーカーを保存しました。',
    'maker.admin.save.error' => 'メーカーを保存できませんでした。',
    'maker.admin.delete.complete' => 'メーカーを削除しました。',
    'maker.admin.delete.error' => 'メーカーを削除できませんでした。',
    'maker.admin.blank.error' => 'メーカー名が入力されていません。',
    'maker.admin.not_found' => 'メーカーが見つかりません。',
    'maker.admin.placeholder.url' => 'メーカーの商品ページのURL',
    'maker.admin.delete.confirm' => 'メーカー情報を削除してもよろしいですか？',
    'maker.admin.delete.confirm.message' => 'メーカー情報を削除します。',
    'maker.admin.title' => 'メーカー管理',
    'maker.admin.sub_title' => '商品管理',
    'maker.admin.maker' => 'メーカー',
    'maker.admin.maker.register' => '新規作成',
    'maker.admin.drag&drop' => '項目の順番はドラッグ＆ドロップでも変更可能です。',
    'maker.admin.product_maker.title' => 'メーカー設定',
    'maker.admin.maker.add' => '追加',
    'maker.admin.maker.edit' => '編集',
    'maker.admin.product_maker.maker' => 'メーカー名',
    'maker.admin.product_maker.maker_url' => 'メーカーURL',
