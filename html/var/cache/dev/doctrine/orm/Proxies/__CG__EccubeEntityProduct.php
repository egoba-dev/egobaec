...
class Product extends \Eccube\Entity\Product implements \Doctrine\ORM\Proxy\Proxy
{
     ...
     * {@inheritDoc}
     */
    public function setMaker(\Plugin\Maker42\Entity\Maker $Maker = NULL)
    {
    ...
    public function getMakerUrl()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMakerUrl', []);

        return parent::getMakerUrl();
    }
    ...
    public function setMakerUrl($maker_url)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setMakerUrl', [$maker_url]);

        return parent::setMakerUrl($maker_url);
    }
