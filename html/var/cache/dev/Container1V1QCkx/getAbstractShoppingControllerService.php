...
class getAbstractShoppingControllerService extends Eccube_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.yavtKk.'] ?? $container->load('get_ServiceLocator_YavtKk_Service'))->withContext('Eccube\\Controller\\AbstractShoppingController', $container));
