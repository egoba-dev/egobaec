 ...
 */
class getBlockController2Service extends Eccube_KernelDevDebugContainer
{
    /**
     * Gets the public 'Plugin\LeftTextBlock\Controller\BlockController' shared autowired service.
     *
     * @return \Plugin\LeftTextBlock\Controller\BlockController
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Eccube/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/app/Plugin/LeftTextBlock/Controller/BlockController.php';

        $container->services['Plugin\\LeftTextBlock\\Controller\\BlockController'] = $instance = new \Plugin\LeftTextBlock\Controller\BlockController(($container->privates['Plugin\\LeftTextBlock\\Repository\\LeftTextBlockRepository'] ?? $container->getLeftTextBlockRepositoryService()), ($container->services['.container.private.twig'] ?? $container->get_Container_Private_TwigService()));
