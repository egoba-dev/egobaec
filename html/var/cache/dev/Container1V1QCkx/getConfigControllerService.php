 ...
 */
class getConfigControllerService extends Eccube_KernelDevDebugContainer
{
    /**
     * Gets the public 'Plugin\CarouselFeature\Controller\Admin\ConfigController' shared autowired service.
     *
     * @return \Plugin\CarouselFeature\Controller\Admin\ConfigController
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Eccube/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/app/Plugin/CarouselFeature/Controller/Admin/ConfigController.php';

        $container->services['Plugin\\CarouselFeature\\Controller\\Admin\\ConfigController'] = $instance = new \Plugin\CarouselFeature\Controller\Admin\ConfigController(($container->privates['Plugin\\CarouselFeature\\Service\\ConfigService'] ?? $container->load('getConfigServiceService')));
        ...
        $instance->setContainer(($container->privates['.service_locator.EGyensF'] ?? $container->load('get_ServiceLocator_EGyensFService'))->withContext('Plugin\\CarouselFeature\\Controller\\Admin\\ConfigController', $container));
