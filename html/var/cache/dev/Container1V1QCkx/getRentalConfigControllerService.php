 ...
 */
class getRentalConfigControllerService extends Eccube_KernelDevDebugContainer
{
    /**
     * Gets the public 'Plugin\Rental\Controller\Admin\RentalConfigController' shared autowired service.
     *
     * @return \Plugin\Rental\Controller\Admin\RentalConfigController
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Eccube/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/app/Plugin/Rental/Controller/Admin/RentalConfigController.php';

        $container->services['Plugin\\Rental\\Controller\\Admin\\RentalConfigController'] = $instance = new \Plugin\Rental\Controller\Admin\RentalConfigController(($container->privates['Plugin\\Rental\\Repository\\RentalConfigRepository'] ?? $container->load('getRentalConfigRepositoryService')));
        ...
        $instance->setContainer(($container->privates['.service_locator.mx0UMmY'] ?? $container->load('get_ServiceLocator_Mx0UMmYService'))->withContext('Plugin\\Rental\\Controller\\Admin\\RentalConfigController', $container));
