 ...
 */
class getProductImageControllerService extends Eccube_KernelDevDebugContainer
{
    /**
     * Gets the public 'Plugin\CategoryProductBlock\Controller\ProductImageController' shared autowired service.
     *
     * @return \Plugin\CategoryProductBlock\Controller\ProductImageController
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Eccube/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/app/Plugin/CategoryProductBlock/Controller/ProductImageController.php';

        $container->services['Plugin\\CategoryProductBlock\\Controller\\ProductImageController'] = $instance = new \Plugin\CategoryProductBlock\Controller\ProductImageController();
        ...
        $instance->setContainer(($container->privates['.service_locator.mx0UMmY'] ?? $container->load('get_ServiceLocator_Mx0UMmYService'))->withContext('Plugin\\CategoryProductBlock\\Controller\\ProductImageController', $container));
